        ...
        <TabPanel className="flex gap-20 items-center flex-col-reverse md:flex-row-reverse transition-all">
          ...
          >
            ...
            <p className="text-base font-normal text-neutral-700 dark:text-neutral-300">
              I have 2 years of experience in web development. My technical
              skill set includes HTML, CSS, JavaScript, and Tailwind CSS for
              designing responsive and modern user interfaces. I work with React
              for front-end development and use Node.js, Express.js, and NestJS
              for building scalable backend services. I have hands-on experience
              with databases like MongoDB, MySQL, and PostgreSQL. I’m also
              familiar with cloud platforms such as AWS, DigitalOcean, Firebase,
              and Google Cloud Platform (GCP) for deploying and managing
              applications.
            </p>
